...
train.py \
    ...
    --llm_pad_token "pad" \
    --version ${version} \
    --train_split_path "path/to/data/preference/refined_train_split_preference.json" \
    --eval_split_path "path/to/data/preference/eval_split_preference.json" \
